...
[Route("deportation_cases")]
public sealed class DeportationCasesController : Controller
{
    const int NUMBER_OF_ENTRIES = 25;

    private readonly IFetchCasesService _fetchCasesService;
    private readonly ILogger<DeportationCasesController> _logger;
    private readonly ISiteDataService _siteDataService;
    private readonly IUserService _userService;

    public DeportationCasesController(
        ILogger<DeportationCasesController> logger,
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var cases = await _fetchCasesService.FetchCases(NUMBER_OF_ENTRIES, startIndex, tenantId, userId, ViewModel.CaseType.Deportation);
        ...
        return View("DeportationCases", cases);
    }
