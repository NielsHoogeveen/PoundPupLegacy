...
[Route("wrongful_removal_cases")]
public sealed class WrongfulRemovalCasesController : Controller
{
    const int NUMBER_OF_ENTRIES = 25;

    private readonly IFetchCasesService _fetchCasesService;
    private readonly ILogger<WrongfulRemovalCasesController> _logger;
    private readonly ISiteDataService _siteDataService;
    private readonly IUserService _userService;

    public WrongfulRemovalCasesController(
        ILogger<WrongfulRemovalCasesController> logger,
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var cases = await _fetchCasesService.FetchCases(NUMBER_OF_ENTRIES, startIndex, tenantId, userId, ViewModel.CaseType.WrongfulRemoval);
        ...
        return View("WrongfulRemovalCases", cases);
    }
