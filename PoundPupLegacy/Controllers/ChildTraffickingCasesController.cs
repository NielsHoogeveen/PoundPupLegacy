...
[Route("child_trafficking_cases")]
public sealed class ChildTraffickingCasesController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var cases = await _fetchCasesService.FetchCases(NUMBER_OF_ENTRIES, startIndex, tenantId, userId, CaseType.ChildTrafficking);
        ...
        return View("ChildTraffickingCases", cases);
    }
