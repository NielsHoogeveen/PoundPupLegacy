...
public class DisruptedPlacementCasesController : Controller
{
    ...
    private readonly ILogger<DisruptedPlacementCasesController> _logger;
    private readonly ISiteDataService _siteDataService;
    private readonly IUserService _userService;

    public DisruptedPlacementCasesController(
        ILogger<DisruptedPlacementCasesController> logger,
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var cases = await _fetchCasesService.FetchCases(NUMBER_OF_ENTRIES, startIndex, tenantId, userId, ViewModel.CaseType.DisruptedPlacement);
        ...
        return View("DisruptedPlacementCases", cases);
    }
