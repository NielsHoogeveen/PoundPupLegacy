...
public sealed class WrongfulMedicationCasesController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var cases = await _fetchCasesService.FetchCases(NUMBER_OF_ENTRIES, startIndex, tenantId, userId, CaseType.WrongfulMedication);
