...
public class UserTenantActionReader: DatabaseReader, IEnumerableDatabaseReader<UserTenantActionReader, UserTenantActionReader.UserTenantActionRequest, UserTenantAction>
{
    public record UserTenantActionRequest
    {

    }
    private UserTenantActionReader(NpgsqlCommand command) : base(command)
    {
    }
    public async IAsyncEnumerable<UserTenantAction> ReadAsync(UserTenantActionRequest request)
    {
    ...
    public static async Task<UserTenantActionReader> CreateAsync(NpgsqlConnection connection)
    {
