...
public sealed class Program
{
    public static async Task Main(string[] args)
    {
        IJsonTypeInfoResolver[] resolvers = new IJsonTypeInfoResolver[] {
            ...
            EditModel.ExistingInterOrganizationalRelationJsonContext.Default,
            EditModel.ExistingInterPersonalRelationJsonContext.Default,
            ...
            EditModel.PartyItemOrganizationListItemJsonContext.Default,
            EditModel.OrganizationTypeJsonContext.Default,
            EditModel.PartyItemPersonListItemJsonContext.Default,
            ...
            EditModel.PartyItemPersonListItemJsonContext.Default,
            EditModel.ExistingPersonOrganizationRelationJsonContext.Default,
