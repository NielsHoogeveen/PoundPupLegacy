...
/// </summary>
public class ValidationMessage2<TValue> : ComponentBase, IDisposable
{
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        Type typ = typeof(EditContext);
        FieldInfo type = typ.GetField("_fieldStates", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        var value = type.GetValue(CurrentEditContext);
