...
using Request = PartyPoliticalEntityRelationType.ToUpdate;

internal sealed class PartyPoliticalEntityRelationTypeChangerFactory(
...
internal sealed class PartyPoliticalEntityRelationTypeUpdaterFactory : DatabaseUpdaterFactory<Request>
{
