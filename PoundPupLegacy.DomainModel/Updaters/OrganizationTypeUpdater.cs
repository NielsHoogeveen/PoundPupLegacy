...
using Request = OrganizationType.ToUpdate;

internal sealed class OrganizationTypeChangerFactory(
...
internal sealed class OrganizationTypeUpdaterFactory : DatabaseUpdaterFactory<Request>
{
