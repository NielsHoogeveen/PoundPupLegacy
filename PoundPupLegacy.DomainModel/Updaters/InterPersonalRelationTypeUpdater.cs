...
using Request = InterPersonalRelationType.ToUpdate;

internal sealed class InterPersonalRelationTypeChangerFactory(
...
internal sealed class InterPersonalRelationTypeUpdaterFactory : DatabaseUpdaterFactory<Request>
{
