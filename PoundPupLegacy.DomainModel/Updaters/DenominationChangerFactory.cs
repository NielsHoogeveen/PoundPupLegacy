...
using Request = Denomination.ToUpdate;

internal sealed class DenominationChangerFactory(
...
internal sealed class DenominationUpdaterFactory : DatabaseUpdaterFactory<Request>
{
