...
using Request = InterOrganizationalRelationType.ToUpdate;

internal sealed class InterOrganizationalRelationTypeChangerFactory(
...
internal sealed class InterOrganizationalRelationTypeUpdaterFactory : DatabaseUpdaterFactory<Request>
{
