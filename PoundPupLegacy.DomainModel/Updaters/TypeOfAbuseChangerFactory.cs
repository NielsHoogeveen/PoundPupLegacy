...
using Request = TypeOfAbuse.ToUpdate;

internal sealed class TypeOfAbuseChangerFactory(
...
internal sealed class TypeOfAbuseUpdaterFactory : DatabaseUpdaterFactory<Request>
{
