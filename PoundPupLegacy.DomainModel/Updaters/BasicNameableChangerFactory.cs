...
using Request = BasicNameable.ToUpdate;

internal sealed class BasicNameableChangerFactory(
...
internal sealed class BasicNameableUpdaterFactory : DatabaseUpdaterFactory<Request>
{
