...
using Request = PersonOrganizationRelationType.ToUpdate;

internal sealed class PersonOrganizationRelationTypeChangerFactory(
...
internal sealed class PersonOrganizationRelationTypeUpdaterFactory : DatabaseUpdaterFactory<Request>
{
