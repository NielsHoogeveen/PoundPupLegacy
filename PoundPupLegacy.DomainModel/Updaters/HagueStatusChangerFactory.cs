...
using Request = HagueStatus.ToUpdate;

internal sealed class HagueStatusChangerFactory(
...
internal sealed class HagueStatusUpdaterFactory : DatabaseUpdaterFactory<Request>
{
