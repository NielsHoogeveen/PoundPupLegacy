...
using Request = TypeOfAbuser.ToUpdate;

internal sealed class TypeOfAbuserChangerFactory(
...
internal sealed class TypeOfAbuserUpdaterFactory : DatabaseUpdaterFactory<Request>
{
