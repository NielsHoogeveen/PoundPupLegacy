...
using Request = Profession.ToUpdate;

internal sealed class ProfessionChangerFactory(
...
internal sealed class ProfessionUpdaterFactory : DatabaseUpdaterFactory<Request>
{
