...
) : IEnumerableMapper<InterPersonalRelation.To.Complete.Resolved.ToCreate, CreateModel.InterPersonalRelation.ToCreate.ForExistingParticipants>
{
    public IEnumerable<CreateModel.InterPersonalRelation.ToCreate.ForExistingParticipants> Map(IEnumerable<InterPersonalRelation.To.Complete.Resolved.ToCreate> source)
    {
