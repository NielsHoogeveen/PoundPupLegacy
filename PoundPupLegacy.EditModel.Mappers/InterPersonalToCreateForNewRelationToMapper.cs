...
internal class InterPersonalToCreateForNewRelationToMapper(
 ...
 ) : IEnumerableMapper<InterPersonalRelation.To.Complete.ToCreateForNewPerson, CreateModel.InterPersonalRelation.ToCreate.ForNewPersonTo>
{
    public IEnumerable<CreateModel.InterPersonalRelation.ToCreate.ForNewPersonTo> Map(IEnumerable<InterPersonalRelation.To.Complete.ToCreateForNewPerson> source)
    {
