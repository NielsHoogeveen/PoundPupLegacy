...
) : IEnumerableMapper<PersonOrganizationRelation.ForPerson.Complete.Resolved.ToUpdate, DomainModel.PersonOrganizationRelation.ToUpdate>
{
    public IEnumerable<DomainModel.PersonOrganizationRelation.ToUpdate> Map(IEnumerable<PersonOrganizationRelation.ForPerson.Complete.Resolved.ToUpdate> source)
    {
