...
) : IEnumerableMapper<InterPersonalRelation.From.Complete.Resolved.ToCreate, DomainModel.InterPersonalRelation.ToCreate.ForExistingParticipants>
{
    public IEnumerable<DomainModel.InterPersonalRelation.ToCreate.ForExistingParticipants> Map(IEnumerable<InterPersonalRelation.From.Complete.Resolved.ToCreate> source)
    {
