...
internal sealed class RepresentativeHouseBillActionWriter : DatabaseWriter<RepresentativeHouseBillAction>, IDatabaseWriter<RepresentativeHouseBillAction>
{
    ...
    public static async Task<DatabaseWriter<RepresentativeHouseBillAction>> CreateAsync(NpgsqlConnection connection)
    {
        ...
        return new RepresentativeHouseBillActionWriter(command, genarateIdCommand);

    }

    private NpgsqlCommand _generateIdCommand;

    internal RepresentativeHouseBillActionWriter(NpgsqlCommand command, NpgsqlCommand generateIdCommand) : base(command)
    {
