...
internal sealed class InterCountryRelationWriter : DatabaseWriter<InterCountryRelation>, IDatabaseWriter<InterCountryRelation>
{
    ...
    public static async Task<DatabaseWriter<InterCountryRelation>> CreateAsync(NpgsqlConnection connection)
    {
        ...
        return new InterCountryRelationWriter(command);
    }

    internal InterCountryRelationWriter(NpgsqlCommand command) : base(command)
    {
    }

    internal override async Task WriteAsync(InterCountryRelation interCountryRelation)
    {
