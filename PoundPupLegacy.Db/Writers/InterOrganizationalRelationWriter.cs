...
internal sealed class InterOrganizationalRelationWriter : DatabaseWriter<InterOrganizationalRelation>, IDatabaseWriter<InterOrganizationalRelation>
{
    ...
    public static async Task<DatabaseWriter<InterOrganizationalRelation>> CreateAsync(NpgsqlConnection connection)
    {
        ...
        return new InterOrganizationalRelationWriter(command);

    }

    internal InterOrganizationalRelationWriter(NpgsqlCommand command) : base(command)
    {
    }
