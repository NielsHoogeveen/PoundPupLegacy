...
internal sealed class PartyPoliticalEntityRelationWriter : DatabaseWriter<PartyPoliticalEntityRelation>, IDatabaseWriter<PartyPoliticalEntityRelation>
{
    ...
    public static async Task<DatabaseWriter<PartyPoliticalEntityRelation>> CreateAsync(NpgsqlConnection connection)
    {
        ...
        return new PartyPoliticalEntityRelationWriter(command);

    }

    internal PartyPoliticalEntityRelationWriter(NpgsqlCommand command) : base(command)
    {
    }
