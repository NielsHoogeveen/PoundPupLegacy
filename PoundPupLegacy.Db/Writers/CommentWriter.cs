...
public class CommentWriter : DatabaseWriter<Comment>, IDatabaseWriter<Comment>
{
    ...
    public static async Task<DatabaseWriter<Comment>> CreateAsync(NpgsqlConnection connection)
    {
        ...
        return new CommentWriter(commandWithId, commandWithoutId);
    }


    private NpgsqlCommand _identityCommand { get; }
    private CommentWriter(NpgsqlCommand command, NpgsqlCommand identityCommand) : base(command)
    {
