...
internal sealed class CountrySubdivisionTypeWriter : DatabaseWriter<CountrySubdivisionType>, IDatabaseWriter<CountrySubdivisionType>
{

    private const string COUNTRY_ID = "country_id";
    private const string SUBDIVISION_TYPE_ID = "subdivision_type_id";
    public static async Task<DatabaseWriter<CountrySubdivisionType>> CreateAsync(NpgsqlConnection connection)
    {
