...
) : IEntityCreatorFactory<EventuallyIdentifiablePollQuestion, PollQuestionCreator>
{
    public async Task<PollQuestionCreator> CreateAsync(IDbConnection connection) =>
        new (
            new () {
