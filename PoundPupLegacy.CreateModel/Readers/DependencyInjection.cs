...
internal static class DependencyInjection
{
    internal static void AddCreateModelReaders(this IServiceCollection services)
    {
        ...
        services.AddTransient<ISingleItemDatabaseReaderFactory<TenantNodeReaderByUrlIdRequest, TenantNode.ToCreateForExistingNode>, TenantNodeReaderByUrlIdFactory>();
