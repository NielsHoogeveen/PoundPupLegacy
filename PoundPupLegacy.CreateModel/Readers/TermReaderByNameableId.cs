...
public sealed class TermReaderByNameableIdFactory : DatabaseReaderFactory<Reader>
{
...
public sealed class TermReaderByNameableId : MandatorySingleItemDatabaseReader<Reader.Request, Term>
{
