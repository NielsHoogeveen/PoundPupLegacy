...
internal sealed class TenantNodeReaderByUrlIdFactory : SingleItemDatabaseReaderFactory<Request, NewTenantNodeForExistingNode>
{
    ...
    protected override NewTenantNodeForExistingNode Read(NpgsqlDataReader reader)
    {
