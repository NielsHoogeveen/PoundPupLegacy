...
public abstract record CoercedAdoptionCase : Case
{
    ...
    public abstract T Match<T>(Func<CoercedAdoptionCaseToCreate, T> create, Func<CoercedAdoptionCaseToUpdate, T> update);
    public abstract void Match(Action<CoercedAdoptionCaseToCreate> create, Action<CoercedAdoptionCaseToUpdate> update);

    public sealed record CoercedAdoptionCaseToCreate : CoercedAdoptionCase, CaseToCreate
    {
        ...
        public override T Match<T>(Func<CoercedAdoptionCaseToCreate, T> create, Func<CoercedAdoptionCaseToUpdate, T> update)
        {
            return create(this);
        }
        public override void Match(Action<CoercedAdoptionCaseToCreate> create, Action<CoercedAdoptionCaseToUpdate> update)
        {
            create(this);
        }
    }
    public sealed record CoercedAdoptionCaseToUpdate : CoercedAdoptionCase, CaseToUpdate
    {
