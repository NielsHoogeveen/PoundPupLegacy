...
public abstract record WrongfulMedicationCase : Case
{
    ...
    public abstract T Match<T>(Func<WrongfulMedicationCaseToCreate, T> create, Func<WrongfulMedicationCaseToUpdate, T> update);
    public abstract void Match(Action<WrongfulMedicationCaseToCreate> create, Action<WrongfulMedicationCaseToUpdate> update);

    public sealed record WrongfulMedicationCaseToCreate : WrongfulMedicationCase, CaseToCreate
    {
        ...
        public override T Match<T>(Func<WrongfulMedicationCaseToCreate, T> create, Func<WrongfulMedicationCaseToUpdate, T> update)
        {
            return create(this);
        }
        public override void Match(Action<WrongfulMedicationCaseToCreate> create, Action<WrongfulMedicationCaseToUpdate> update)
        {
            create(this);
        }
    }
