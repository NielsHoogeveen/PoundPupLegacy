...
internal sealed class BasicNameableUpdateDocumentReaderFactory : NodeUpdateDocumentReaderFactory<BasicNameable.ToUpdate>
{
    public override string Sql => string.Format(SQL, "tn");

    protected override int NodeTypeId => Constants.BASIC_NAMEABLE;
