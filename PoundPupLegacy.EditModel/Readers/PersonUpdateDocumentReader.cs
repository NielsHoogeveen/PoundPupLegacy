...
internal sealed class PersonUpdateDocumentReaderFactory : NodeUpdateDocumentReaderFactory<Person>
{
    ...
    const string SQL = $"""
            {CTE_EDIT},
            {INTER_PERSONAL_RELATION_TYPES_DOCUMENT},
            {PERSON_PERSONAL_RELATION_TYPES_DOCUMENT},
    ...
    const string INTER_PERSONAL_RELATION_TYPES_DOCUMENT = """
        ...
        """;
    const string PERSON_PERSONAL_RELATION_TYPES_DOCUMENT = """
