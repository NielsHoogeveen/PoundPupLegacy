...
internal sealed class InterOrganizationalRelationTypeUpdateDocumentReaderFactory : NodeUpdateDocumentReaderFactory<InterOrganizationalRelationType.ToUpdate>
{
    public override string Sql => string.Format(SQL, "tn");

    protected override int NodeTypeId => Constants.INTER_ORGANIZATIONAL_RELATION_TYPE;
    ...
    const string SQL = $"""
            ...
            from node n
            join inter_organizational_relation_type r on r.id = n.id
