...
using Request = DocumentsReaderRequest;
using SearchOption = Common.SearchOption;

public sealed record DocumentsReaderRequest : IRequest
{
    public required int TenantId { get; init; }
    public required string SearchString { get; init; }
}

internal sealed class DocumentsReaderFactory : EnumerableDatabaseReaderFactory<Request, DocumentListItem>
{
    ...
    protected override DocumentListItem Read(NpgsqlDataReader reader)
    {
