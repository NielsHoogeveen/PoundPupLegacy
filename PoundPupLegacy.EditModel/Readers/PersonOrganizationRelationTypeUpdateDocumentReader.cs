...
internal sealed class PersonOrganizationRelationTypeUpdateDocumentReaderFactory : NodeUpdateDocumentReaderFactory<PersonOrganizationRelationType.ToUpdate>
{
    public override string Sql => string.Format(SQL, "tn");

    protected override int NodeTypeId => Constants.PERSON_ORGANIZATION_RELATION_TYPE;
