...
using Request = GeographicalEntitiesReaderRequest;
using SearchOption = Common.SearchOption;

public sealed record GeographicalEntitiesReaderRequest : IRequest
{
    public required int TenantId { get; init; }
    public required string SearchString { get; init; }
}

internal sealed class GeographicalEntitiesReaderFactory : EnumerableDatabaseReaderFactory<Request, GeographicalEntityListItem>
{
    ...
    protected override GeographicalEntityListItem Read(NpgsqlDataReader reader)
    {
        return new GeographicalEntityListItem {
