...
internal sealed class TypeOfAbuserUpdateDocumentReaderFactory : NodeUpdateDocumentReaderFactory<TypeOfAbuser.ToUpdate>
{
    public override string Sql => string.Format(SQL, "tn");

    protected override int NodeTypeId => Constants.TYPE_OF_ABUSER;
