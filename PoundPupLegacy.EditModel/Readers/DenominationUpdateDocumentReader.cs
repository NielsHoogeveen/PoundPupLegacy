...
internal sealed class DenominationUpdateDocumentReaderFactory : NodeUpdateDocumentReaderFactory<Denomination.ToUpdate>
{
    public override string Sql => string.Format(SQL, "tn");

    protected override int NodeTypeId => Constants.DENOMINATION;
