...
internal sealed class DocumentTypeUpdateDocumentReaderFactory : NodeUpdateDocumentReaderFactory<DocumentType.ToUpdate>
{
    public override string Sql => string.Format(SQL, "tn");

    protected override int NodeTypeId => Constants.DOCUMENT_TYPE;
