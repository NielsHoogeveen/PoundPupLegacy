...
internal sealed class WrongfulRemovalCaseUpdateDocumentReaderFactory : NodeUpdateDocumentReaderFactory<WrongfulRemovalCase.ExistingWrongfulRemovalCase>
{
    ...
    const string SQL = $"""
            ...
            join wrongful_removal_case wrc on wrc.id = c.id
