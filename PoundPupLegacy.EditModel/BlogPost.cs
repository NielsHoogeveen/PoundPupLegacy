...
public abstract record BlogPost : SimpleTextNode, ResolvedNode, Node<BlogPost.ToUpdate, BlogPost.ToCreate>, Resolver<BlogPost.ToUpdate, BlogPost.ToCreate>
{
    private BlogPost() { }
    public Node<ToUpdate, ToCreate> Resolve() => this;
