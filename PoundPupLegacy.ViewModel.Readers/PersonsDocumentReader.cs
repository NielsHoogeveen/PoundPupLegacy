...
public class PersonsDocumentReader : DatabaseReader, IDatabaseReader<PersonsDocumentReader>
{
    private PersonsDocumentReader(NpgsqlCommand command) : base(command)
    {
    }

    public async Task<Persons> ReadAsync(int userId, int tenantId, int limit, int offset, string searchTerm, SearchOption searchOption)
    {
