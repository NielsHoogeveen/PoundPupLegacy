...
internal sealed class FileWriter : DatabaseWriter<CreateModel.File>, IDatabaseWriter<CreateModel.File>
{
    ...
    public static async Task<DatabaseWriter<CreateModel.File>> CreateAsync(NpgsqlConnection connection)
    {
