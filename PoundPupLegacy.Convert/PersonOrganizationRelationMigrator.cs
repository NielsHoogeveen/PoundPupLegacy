...
internal sealed class PersonOrganizationRelationMigrator: Migrator
{
    public PersonOrganizationRelationMigrator(MySqlToPostgresConverter mySqlToPostgresConverter) : base(mySqlToPostgresConverter)
    {
    }
    ...
    {
        await PersonOrganizationRelationCreator.CreateAsync(ReadPersonOrganizationRelations(), _postgresConnection);
