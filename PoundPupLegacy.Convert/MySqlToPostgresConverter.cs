...
internal partial class MySqlToPostgresConverter: IAsyncDisposable
{
    ...
    public async Task Convert()
    {
        ...
        await (new PartyPoliticalEntityRelationMigrator(this)).Migrate();
        await (new PersonOrganizationRelationMigrator(this)).Migrate();
        await (new InterOrganizationalRelationMigrator(this)).Migrate();
        await (new InterPersonalRelationMigrator(this)).Migrate();
