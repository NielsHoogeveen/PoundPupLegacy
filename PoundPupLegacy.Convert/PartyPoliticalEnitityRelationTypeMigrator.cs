...
internal sealed class PartyPoliticalEnitityRelationTypeMigrator: Migrator
{
    public PartyPoliticalEnitityRelationTypeMigrator(MySqlToPostgresConverter converter) : base(converter) { }
