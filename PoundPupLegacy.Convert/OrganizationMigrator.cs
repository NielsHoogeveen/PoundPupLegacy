...
internal sealed class OrganizationMigrator: Migrator
{
    public OrganizationMigrator(MySqlToPostgresConverter mySqlToPostgresConverter) : base(mySqlToPostgresConverter)
    {
    }
    ...
    protected override async Task MigrateImpl()
    {
        ...
        await OrganizationCreator.CreateAsync(ReadOrganizationsPPL(), _postgresConnection);
        await OrganizationCreator.CreateAsync(ReadOrganizationsCPCT(), _postgresConnection);
    }
    private async IAsyncEnumerable<Organization> ReadOrganizationsPPL()
    {
    ...
    private async IAsyncEnumerable<Organization> ReadOrganizationsCPCT()
    {
