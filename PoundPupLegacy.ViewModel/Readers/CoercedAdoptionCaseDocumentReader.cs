...
internal sealed class CoercedAdoptionCaseDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, CoercedAdoptionCase>
{
    ...
    const string SQL = $"""
            ...
            {BREADCRUM_DOCUMENT},
            {DOCUMENT}
            SELECT document from coerced_adoption_case_document
            """
            ;
    ...
    protected override CoercedAdoptionCase? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<CoercedAdoptionCase>(0);
    }
}
