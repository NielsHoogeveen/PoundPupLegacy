...
internal sealed class InformalSubdivisionDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, InformalSubdivision>
{
    ...
    const string SQL = $"""
            ...
            {DOCUMENT}
            SELECT document from informal_subdivision_document
            """
            ;
    ...
    protected override InformalSubdivision? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<InformalSubdivision>(0);
    }
}
