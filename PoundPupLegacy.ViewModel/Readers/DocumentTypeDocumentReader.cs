...
internal sealed class DocumentTypeDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, DocumentType>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join denomination bn on bn.id = n.id
    ...
    protected override DocumentType? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<DocumentType>(0);
    }
}
