...
internal sealed class TypeOfAbuseDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, TypeOfAbuse>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join type_of_abuse bn on bn.id = n.id
    ...
    protected override TypeOfAbuse? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<TypeOfAbuse>(0);
    }
}
