...
internal sealed class DiscussionDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, Discussion>
{
    ...
    const string SQL = $"""
            ...
            {BREADCRUM_DOCUMENT},
            {DOCUMENT}
            SELECT document from discussion_document
            """
            ;
    ...
    protected override Discussion? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<Discussion>(0);
    }
}
