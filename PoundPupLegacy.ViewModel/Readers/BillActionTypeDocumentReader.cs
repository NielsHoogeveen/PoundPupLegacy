...
internal sealed class BillActionTypeDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, BillActionType>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join bill_action_type bn on bn.id = n.id
    ...
    protected override BillActionType? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<BillActionType>(0);
    }
}
