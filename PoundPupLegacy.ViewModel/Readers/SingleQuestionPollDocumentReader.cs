...
internal sealed class SingleQuestionPollDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, SingleQuestionPoll>
{
    ...
    const string SQL = $"""
            ...
            {DOCUMENT}
            SELECT document from single_question_poll_document
            """
            ;
    ...
    protected override SingleQuestionPoll? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<SingleQuestionPoll>(0);
    }
}
