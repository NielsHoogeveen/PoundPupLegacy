...
internal sealed class WrongfulMedicationCaseDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, WrongfulMedicationCase>
{
    ...
    const string SQL = $"""
            ...
            {BREADCRUM_DOCUMENT},
            {DOCUMENT}
            SELECT document from wrongful_medication_case_document
            """
            ;
    ...
    protected override WrongfulMedicationCase? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<WrongfulMedicationCase>(0);
    }
}
