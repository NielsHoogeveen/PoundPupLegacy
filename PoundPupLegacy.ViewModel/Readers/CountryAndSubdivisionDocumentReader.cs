...
internal sealed class CountryAndSubdivisionDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, CountryAndSubdivision>
{
    ...
    const string SQL = $"""
            ...
            {DOCUMENT}
            SELECT document from country_and_subdivision_document
            """
            ;
    ...
    protected override CountryAndSubdivision? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<CountryAndSubdivision>(0);
    }
}
