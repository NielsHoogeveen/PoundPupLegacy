...
internal sealed class DisruptedPlacementCaseDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, DisruptedPlacementCase>
{
    ...
    const string SQL = $"""
            ...
            {BREADCRUM_DOCUMENT},
            {DOCUMENT}
            SELECT document from disrupted_placement_case_document
            """
            ;
    ...
    protected override DisruptedPlacementCase? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<DisruptedPlacementCase>(0);
    }
}
