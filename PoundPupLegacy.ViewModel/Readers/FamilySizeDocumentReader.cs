...
internal sealed class FamilySizeDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, FamilySize>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join family_size bn on bn.id = n.id
    ...
    protected override FamilySize? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<FamilySize>(0);
    }
}
