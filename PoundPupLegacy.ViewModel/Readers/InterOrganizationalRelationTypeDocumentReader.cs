...
internal sealed class InterOrganizationalRelationTypeDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, InterOrganizationalRelationType>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join inter_organizational_relation_type bn on bn.id = n.id
    ...
    protected override InterOrganizationalRelationType? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<InterOrganizationalRelationType>(0);
    }
}
