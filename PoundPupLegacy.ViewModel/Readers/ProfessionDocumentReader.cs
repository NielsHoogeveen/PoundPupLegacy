...
internal sealed class ProfessionDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, Profession>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join profession bn on bn.id = n.id
    ...
    protected override Profession? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<Profession>(0);
    }
}
