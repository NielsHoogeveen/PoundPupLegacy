...
internal sealed class InterPersonalRelationTypeDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, InterPersonalRelationType>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join inter_personal_relation_type bn on bn.id = n.id
    ...
    protected override InterPersonalRelationType? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<InterPersonalRelationType>(0);
    }
}
