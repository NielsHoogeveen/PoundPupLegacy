...
internal sealed class BasicCountryDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, BasicCountry>
{
    ...
    const string SQL = $"""
            ...
            {DOCUMENT}
            SELECT document from basic_country_document
            """
            ;
    ...
    protected override BasicCountry? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<BasicCountry>(0);
    }
}
