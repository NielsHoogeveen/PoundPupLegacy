...
internal sealed class GlobalRegionDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, GlobalRegion>
{
    ...
    const string SQL = $"""
            ...
            {BREADCRUM_DOCUMENT},
            {DOCUMENT}
            SELECT document from global_region_document
            """
            ;
    ...
    protected override GlobalRegion? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<GlobalRegion>(0);
    }
}
