...
using Request = WrongfulMedicationCasesDocumentReaderRequest;

public sealed record WrongfulMedicationCasesDocumentReaderRequest : IRequest
{
...
internal sealed class WrongfulMedicationCasesDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, WrongfulMedicationCases>
{
    ...
    private static readonly FieldValueReader<WrongfulMedicationCases> DocumentReader = new() { Name = "document" };
            ...
            from(
        	    ...
        	    from(
                    ...
                    from(
                        ...
                        join wrongful_medication_case ac on ac.id = n2.id
    ...
    protected override WrongfulMedicationCases Read(NpgsqlDataReader reader)
    {
