...
internal sealed class TypeOfAbuserDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, TypeOfAbuser>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join type_of_abuser bn on bn.id = n.id
    ...
    protected override TypeOfAbuser? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<TypeOfAbuser>(0);
    }
}
