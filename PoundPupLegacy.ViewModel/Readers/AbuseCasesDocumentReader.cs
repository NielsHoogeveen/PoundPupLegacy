...
using Request = AbuseCasesDocumentReaderRequest;

public sealed record AbuseCasesDocumentReaderRequest : IRequest
{
...
internal sealed class AbuseCasesDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, AbuseCases>
{
    ...
    private static readonly FieldValueReader<AbuseCases> DocumentReader = new() { Name = "document" };
    ...
    protected override AbuseCases Read(NpgsqlDataReader reader)
    {
