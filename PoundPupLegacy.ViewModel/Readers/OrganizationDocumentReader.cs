...
internal sealed class OrganizationDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, Organization>
{
    ...
    protected override Organization? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<Organization>(0);
    }
}
