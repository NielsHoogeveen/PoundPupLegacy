...
internal sealed class DenominationDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, Denomination>
{
    ...
    protected override Denomination? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<Denomination>(0);
    }
}
