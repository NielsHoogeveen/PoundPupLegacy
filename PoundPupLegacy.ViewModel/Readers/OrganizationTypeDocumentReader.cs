...
internal sealed class OrganizationTypeDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, OrganizationType>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join organization_type bn on bn.id = n.id
    ...
    protected override OrganizationType? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<OrganizationType>(0);
    }
}
