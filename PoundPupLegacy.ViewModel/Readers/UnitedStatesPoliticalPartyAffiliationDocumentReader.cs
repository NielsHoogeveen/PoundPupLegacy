...
internal sealed class UnitedStatesPoliticalPartyAffiliationDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, UnitedStatesPoliticalPartyAffiliation>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join united_states_political_party_affiliation bn on bn.id = n.id
    ...
    protected override UnitedStatesPoliticalPartyAffiliation? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<UnitedStatesPoliticalPartyAffiliation>(0);
    }
}
