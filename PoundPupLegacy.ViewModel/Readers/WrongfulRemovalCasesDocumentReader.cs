...
using Request = WrongfulRemovalCasesDocumentReaderRequest;

public sealed record WrongfulRemovalCasesDocumentReaderRequest : IRequest
{
...
internal sealed class WrongfulRemovalCasesDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, WrongfulRemovalCases>
{
    ...
    private static readonly FieldValueReader<WrongfulRemovalCases> DocumentReader = new() { Name = "document" };
            ...
            from(
        	    ...
        	    from(
                    ...
                    from(
                        ...
                        join wrongful_removal_case ac on ac.id = n2.id
    ...
    protected override WrongfulRemovalCases Read(NpgsqlDataReader reader)
    {
