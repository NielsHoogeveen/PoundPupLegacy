...
internal sealed class ActDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, Act>
{
    ...
    protected override Act? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<Act>(0);
    }
}
