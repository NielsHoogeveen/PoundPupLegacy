...
internal sealed class PartyPoliticalEntityRelationTypeDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, PartyPoliticalEntityRelationType>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join party_political_entity_relation_type bn on bn.id = n.id
    ...
    protected override PartyPoliticalEntityRelationType? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<PartyPoliticalEntityRelationType>(0);
    }
}
