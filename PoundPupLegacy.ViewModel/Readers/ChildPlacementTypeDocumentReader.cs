...
internal sealed class ChildPlacementTypeDocumentReaderFactory : SingleItemDatabaseReaderFactory<Request, ChildPlacementType>
{
    ...
    const string DOCUMENT = """
        basic_nameable_document AS (
            ...
            FROM (
                ...
                join child_placement_type bn on bn.id = n.id
    ...
    protected override ChildPlacementType? Read(NpgsqlDataReader reader)
    {
        return reader.GetFieldValue<ChildPlacementType>(0);
    }
}
